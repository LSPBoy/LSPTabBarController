...
// 按钮的选中文字颜色
#define  TabBarButtonTitleSelectedColor (iOS7 ? RGBColor(234, 103, 7) : RGBColor(248, 139, 0))

#import "LSPTabBarButton.h"
#import "LSPBageButton.h"

@interface LSPTabBarButton()
/**
 *  提醒数字
 */
@property (nonatomic, weak) LSPBageButton *badgeButton;

@end


@implementation LSPTabBarButton
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 添加一个提醒数字按钮
        LSPBageButton *badgeButton = [[LSPBageButton alloc] init];
